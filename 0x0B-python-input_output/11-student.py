...
class Student:
    ...
    def reload_from_json(self, json):
        """
        Replace all attributes of the Student instance with the provided dictionary.

        Args:
        json: A dictionary where a key is the public attribute name and the value is the new value for the attribute.
        """
